...
export default function UpdateApplicationModal() {
  ...
  return (
    <motion.form
      ...
      className="mx-auto max-w-6xl space-y-6 sm:space-y-8 rounded-2xl bg-white p-4 sm:p-6 lg:p-8 shadow-lg"
    >
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <span className="rounded-full bg-blue-50 px-4 py-1 text-sm font-medium text-blue-600 w-fit">
      ...
      <section className="space-y-3 sm:space-y-4">
        <h3 className="text-base sm:text-lg font-semibold text-gray-700">Basic Info</h3>
      ...
      {/* APPLICATION DETAILS */}
      <section className="space-y-3 sm:space-y-4">
        <h3 className="text-base sm:text-lg font-semibold text-gray-700">Application Details</h3>
      ...
      {/* EDUCATION */}
      <section className="space-y-3 sm:space-y-4">
        <h3 className="text-base sm:text-lg font-semibold text-gray-700">Education</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <Input label="Type">
      ...
      {/* META */}
      <section className="space-y-3 sm:space-y-4">
        <h3 className="text-base sm:text-lg font-semibold text-gray-700">Meta</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
      ...
      {/* NOTES */}
      <section className="space-y-3 sm:space-y-4">
        <h3 className="text-base sm:text-lg font-semibold text-gray-700">Notes</h3>
        <textarea
          name="notes"
      ...
      <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 border-t pt-4 sm:pt-6">
        <Link to="/dashboard/services/applications" className="rounded-xl border px-6 py-2 text-center">
          Cancel
        </Link>
